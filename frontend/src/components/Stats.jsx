          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div id="impact" className="grid gap-4 sm:grid-cols-2">
              {impactStats.map(({ value, label, detail, icon: Icon }) => (
                <div key={label} className="group relative rounded-[26px] border border-white/10 bg-slate-950/50 p-5 transition duration-300 hover:-translate-y-1 hover:border-cyan-400/30">
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(6,182,212,0.18),transparent_25%),radial-gradient(circle_at_bottom_right,rgba(16,185,129,0.16),transparent_30%)] opacity-0 transition group-hover:opacity-100" />

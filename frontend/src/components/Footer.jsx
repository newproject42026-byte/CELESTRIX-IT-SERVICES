    ...
    <footer className="border-t border-slate-200 bg-white/90 py-8">
      <div className="section-shell flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-4 text-sm text-slate-500">© 2026 CELESTRIX IT SERVICES. All rights reserved.</p>
        </div>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-emerald-700">
